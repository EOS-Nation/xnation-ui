    ...
    <div class="content d-flex flex-column align-items-start">
      ...
      <div class="wrapper">
        ...
        <p>
          ...
          <a :href="website" class="orange" target="_blank">xnation.io</a>, one
          of our main priorities is the privacy of our visitors. This Privacy
          Policy document contains types of information that is collected and
          recorded by XNation and how we use it.
        </p>
        <p>
        ...
        <p>
          XNation legal basis for collecting and using the personal information
        ...
        <p>
          XNation will retain your personal information only for as long as is
        ...
        <h2>Log Files</h2>
        <p>
          XNation follows a standard procedure of using log files. These files
          log visitors when they visit websites. All hosting companies do this
          as a part of hosting services’ analytics. The information collected by
        ...
        <p>
          Like any other website, XNation uses ‘cookies’. These cookies are used
        ...
        <p>
          Note that XNation has no access to or control over these cookies that
        ...
        <p>
          ...
          they shared and/or collect in XNation. This policy is not applicable
